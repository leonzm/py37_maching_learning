...
import tqdm
from gan_demo.model import NetG, NetD
...
def train(**kwargs):
    for k_, v_ in kwargs.items():
        setattr(opt, k_, v_)
    if opt.vis:
        from gan_demo.visualize import Visualizer
...
if __name__ == '__main__':
    ...
    # train()
    # 随机生成动漫头像
    # generate(netd_path='checkpoints/netd_0.pth', netg_path='checkpoints/netg_0.pth')
    pass
